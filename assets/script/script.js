...
$(document).ready(function headerAnimation(){
    if (large.matches) {
        ...
        setTimeout (function armsSlide() {
            gsap.to("#left_arm", {left:"0%",duration:2,ease:"power2" });
            gsap.to("#right_arm", {right:"0%",duration:2,ease:"power2"});  
        },3000);
    ...
    if (Mac.matches) { 
        ...
        setTimeout (function armsSlideMedium() {
            gsap.to("#left_arm", {left:"-3%",duration:2,ease:"power2" });
            gsap.to("#right_arm", {right:"-4%",duration:2,ease:"power2"});  
        },3000);
        setTimeout (function redBallOpacity(){
            gsap.to("#redBall",{opacity:1,duration:3,})
        },3000);
    ...
    if (desktop.matches) {
        ...
        setTimeout (function armsSlideMedium() {
            gsap.to("#left_arm", {left:"-6%",duration:2,ease:"power2" });
            gsap.to("#right_arm", {right:"-1%",duration:2,ease:"power2"});  
        },3000);
        setTimeout (function redBallOpacity(){
            gsap.to("#redBall",{opacity:1,duration:3,})
        },3000);
    ...
    if (tablet.matches) {
        ...
        setTimeout (function armsSlideTablet() {
            gsap.to("#left_arm", {left:"-12%",duration:2,ease:"power2" });
            gsap.to("#right_arm", {right:"-12%",duration:2,ease:"power2"});  
        },3000);
        setTimeout (function redBallOpacity(){
    ...
    if (IphoneXR.matches) {
        ...
        setTimeout (function armsSlide() {
            gsap.to("#left_arm", {left:"-11%",duration:2,ease:"power2" });
            gsap.to("#right_arm", {right:"-7%",duration:2,ease:"power2"});  
        },3000);
        setTimeout (function redBallOpacity(){
            gsap.to("#redBall",{opacity:1,duration:3,})
            },3000);
